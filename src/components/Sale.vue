<template>
  <section class="sale">
    ...
    <button class="sale__slide-btn sale__btn-left">&lt;</button>
    <button class="sale__slide-btn sale__btn-right">></button>
    <div class="wrap sale__wrap">
      <img
        src="../assets/img/sale-picture.png"
        alt="product picture"
        class="sale__picture"
      />
    </div>
  ...
  <section class="sale__description wrap">
    <h3 class="sale__description__header">WOMEN COLLECTION</h3>
    <hr class="sale__description__header__line" />
    <H4 class="sale__description__item-header">MOSCHINO CHEAP AND CHIC</H4>
    ...
    <p class="sale__description__text price">$561</p>
    ...
    <div class="sale__cart animation-large">
      <button class="sale__cart__button">
        <svg
      ...
      <p class="sale__cart__text">Add to Cart</p>
    </div>
  </section>
</template>
